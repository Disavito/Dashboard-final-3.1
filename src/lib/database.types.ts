    ...
    Tables: {
      boletas_electronicas: {
        Row: {
          ...
          detalles: Json | null
          socio_id: string | null // FIX: Changed from number to string (UUID)
      ...
      socio_titulares: {
        Row: {
          id: string // FIX: Changed from number to string (UUID)
          created_at: string
          dni: string
          nombres: string
      ...
      socio_documentos: {
        Row: {
          id: number
          created_at: string
          socio_id: string // FIX: Changed from number to string (UUID)
